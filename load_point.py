...
class load_point:
    ...
    def show_select_features(self):        
        #self.iface.showAttributeTable(self.iface.activeLayer()).findChild(QAction,'mActionSelectedFilter').trigger()
        ...
        for i in range(len(self.rev_flist)):           #列
            for j in range(len(self.rev_flist[0])):    #行
                ...
                self.new_item=QTableWidgetItem(self.rev_flist[i][j])
